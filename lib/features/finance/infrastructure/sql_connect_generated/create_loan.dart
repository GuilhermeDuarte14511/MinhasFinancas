...
class CreateLoanVariablesBuilder {
  ...
  Optional<DateTime> _contractedAt = Optional.optional(nativeFromJson, nativeToJson);
  DateTime firstDueDate;
  Optional<BigInt> _expectedInstallmentAmountCents = Optional.optional(bigIntFromJson, bigIntToJson);
  Optional<String> _notes = Optional.optional(nativeFromJson, nativeToJson);

  final FirebaseDataConnect _dataConnect;  CreateLoanVariablesBuilder lender(String? t) {
   _lender.value = t;
   return this;
  }
  ...
  CreateLoanVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.name,required  this.principalAmountCents,required  this.monthlyInterestRateMicros,required  this.amortizationMethod,required  this.installmentCount,required  this.firstDueDate,});
  Deserializer<CreateLoanData> dataDeserializer = (dynamic json)  => CreateLoanData.fromJson(jsonDecode(json));
  Serializer<CreateLoanVariables> varsSerializer = (CreateLoanVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateLoanData, CreateLoanVariables>> execute() {
    return ref().execute();
  }

  MutationRef<CreateLoanData, CreateLoanVariables> ref() {
    CreateLoanVariables vars= CreateLoanVariables(spaceId: spaceId,name: name,lender: _lender,principalAmountCents: principalAmountCents,monthlyInterestRateMicros: monthlyInterestRateMicros,amortizationMethod: amortizationMethod,installmentCount: installmentCount,contractedAt: _contractedAt,firstDueDate: firstDueDate,expectedInstallmentAmountCents: _expectedInstallmentAmountCents,notes: _notes,);
    return _dataConnect.mutation("CreateLoan", dataDeserializer, varsSerializer, vars);
  }
}
...
class CreateLoanVariables {
  ...
  amortizationMethod = LoanAmortizationMethod.values.byName(json['amortizationMethod']),
  ...
  firstDueDate = nativeFromJson<DateTime>(json['firstDueDate']) {
    ...
    lender.value = json['lender'] == null ? null : nativeFromJson<String>(json['lender']);
    ...
    contractedAt.value = json['contractedAt'] == null ? null : nativeFromJson<DateTime>(json['contractedAt']);
  
  
  
    expectedInstallmentAmountCents = Optional.optional(bigIntFromJson, bigIntToJson);
    expectedInstallmentAmountCents.value = json['expectedInstallmentAmountCents'] == null ? null : bigIntFromJson(json['expectedInstallmentAmountCents']);
  ...
  @override
  int get hashCode => Object.hashAll([spaceId.hashCode, name.hashCode, lender.hashCode, principalAmountCents.hashCode, monthlyInterestRateMicros.hashCode, amortizationMethod.hashCode, installmentCount.hashCode, contractedAt.hashCode, firstDueDate.hashCode, expectedInstallmentAmountCents.hashCode, notes.hashCode]);
  ...
  Map<String, dynamic> toJson() {
    ...
    if(expectedInstallmentAmountCents.state == OptionalState.set) {
      json['expectedInstallmentAmountCents'] = expectedInstallmentAmountCents.toJson();
    }
