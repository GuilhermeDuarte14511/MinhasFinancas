...
class CreateRecurringCashFlowOccurrenceVariablesBuilder {
  ...
  Optional<Timestamp> _receivedAt = Optional.optional((json) => json['receivedAt'] = Timestamp.fromJson(json['receivedAt']), defaultSerializer);
  Optional<Timestamp> _paidAt = Optional.optional((json) => json['paidAt'] = Timestamp.fromJson(json['paidAt']), defaultSerializer);
  Optional<DateTime> _nextOccurrenceDate = Optional.optional(nativeFromJson, nativeToJson);
  String idempotencyKey;

  final FirebaseDataConnect _dataConnect;  CreateRecurringCashFlowOccurrenceVariablesBuilder receivedAt(Timestamp? t) {
   _receivedAt.value = t;
   return this;
  }
  ...
  CreateRecurringCashFlowOccurrenceVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.seriesId,required  this.occurrenceIndex,required  this.occurredAt,required  this.competenceMonth,required  this.status,required  this.idempotencyKey,});
  Deserializer<CreateRecurringCashFlowOccurrenceData> dataDeserializer = (dynamic json)  => CreateRecurringCashFlowOccurrenceData.fromJson(jsonDecode(json));
  Serializer<CreateRecurringCashFlowOccurrenceVariables> varsSerializer = (CreateRecurringCashFlowOccurrenceVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateRecurringCashFlowOccurrenceData, CreateRecurringCashFlowOccurrenceVariables>> execute() {
    return ref().execute();
  }

  MutationRef<CreateRecurringCashFlowOccurrenceData, CreateRecurringCashFlowOccurrenceVariables> ref() {
    CreateRecurringCashFlowOccurrenceVariables vars= CreateRecurringCashFlowOccurrenceVariables(spaceId: spaceId,seriesId: seriesId,occurrenceIndex: occurrenceIndex,occurredAt: occurredAt,competenceMonth: competenceMonth,status: status,receivedAt: _receivedAt,paidAt: _paidAt,nextOccurrenceDate: _nextOccurrenceDate,idempotencyKey: idempotencyKey,);
    return _dataConnect.mutation("CreateRecurringCashFlowOccurrence", dataDeserializer, varsSerializer, vars);
  }
}
...
class CreateRecurringCashFlowOccurrenceEntry {
  ...
  bool operator ==(Object other) {
    ...
    final CreateRecurringCashFlowOccurrenceEntry otherTyped = other as CreateRecurringCashFlowOccurrenceEntry;
  ...
  CreateRecurringCashFlowOccurrenceEntry({
    required this.id,
  });
}
...
class CreateRecurringCashFlowOccurrenceSeriesProgress {
  ...
  bool operator ==(Object other) {
    ...
    final CreateRecurringCashFlowOccurrenceSeriesProgress otherTyped = other as CreateRecurringCashFlowOccurrenceSeriesProgress;
    return id == otherTyped.id;
  ...
  CreateRecurringCashFlowOccurrenceSeriesProgress({
    required this.id,
  });
}
...
class CreateRecurringCashFlowOccurrenceData {
  ...
  seriesProgress = json['seriesProgress'] == null ? null : CreateRecurringCashFlowOccurrenceSeriesProgress.fromJson(json['seriesProgress']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    final CreateRecurringCashFlowOccurrenceData otherTyped = other as CreateRecurringCashFlowOccurrenceData;
...
class CreateRecurringCashFlowOccurrenceVariables {
  ...
  idempotencyKey = nativeFromJson<String>(json['idempotencyKey']) {
    ...
    receivedAt = Optional.optional((json) => json['receivedAt'] = Timestamp.fromJson(json['receivedAt']), defaultSerializer);
    receivedAt.value = json['receivedAt'] == null ? null : Timestamp.fromJson(json['receivedAt']);
  
  
    paidAt = Optional.optional((json) => json['paidAt'] = Timestamp.fromJson(json['paidAt']), defaultSerializer);
    paidAt.value = json['paidAt'] == null ? null : Timestamp.fromJson(json['paidAt']);
  ...
  bool operator ==(Object other) {
    ...
    final CreateRecurringCashFlowOccurrenceVariables otherTyped = other as CreateRecurringCashFlowOccurrenceVariables;
  ...
  @override
  int get hashCode => Object.hashAll([spaceId.hashCode, seriesId.hashCode, occurrenceIndex.hashCode, occurredAt.hashCode, competenceMonth.hashCode, status.hashCode, receivedAt.hashCode, paidAt.hashCode, nextOccurrenceDate.hashCode, idempotencyKey.hashCode]);
