...
class UpdateCashFlowOccurrenceVariablesBuilder {
  ...
  UpdateCashFlowOccurrenceVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.entryId,required  this.scope,required  this.description,required  this.kind,required  this.paymentMethod,required  this.amountCents,required  this.occurredAt,required  this.competenceMonth,required  this.status,});
  Deserializer<UpdateCashFlowOccurrenceData> dataDeserializer = (dynamic json)  => UpdateCashFlowOccurrenceData.fromJson(jsonDecode(json));
  Serializer<UpdateCashFlowOccurrenceVariables> varsSerializer = (UpdateCashFlowOccurrenceVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateCashFlowOccurrenceData, UpdateCashFlowOccurrenceVariables>> execute() {
    return ref().execute();
  }
...
class UpdateCashFlowOccurrenceEntry {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateCashFlowOccurrenceEntry otherTyped = other as UpdateCashFlowOccurrenceEntry;
...
class UpdateCashFlowOccurrenceData {
  ...
  entry = json['entry'] == null ? null : UpdateCashFlowOccurrenceEntry.fromJson(json['entry']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    final UpdateCashFlowOccurrenceData otherTyped = other as UpdateCashFlowOccurrenceData;
...
class UpdateCashFlowOccurrenceVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateCashFlowOccurrenceVariables otherTyped = other as UpdateCashFlowOccurrenceVariables;
