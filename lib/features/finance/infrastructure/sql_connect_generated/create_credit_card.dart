...
class CreateCreditCardVariablesBuilder {
  String spaceId;
  String nickname;
  Optional<String> _institutionName = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  CreateCreditCardVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateCreditCardData> dataDeserializer = (dynamic json) =>
      CreateCreditCardData.fromJson(jsonDecode(json));
  Serializer<CreateCreditCardVariables> varsSerializer =
      (CreateCreditCardVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateCreditCardData, CreateCreditCardVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateCreditCardData, CreateCreditCardVariables> ref() {
    CreateCreditCardVariables vars = CreateCreditCardVariables(
      spaceId: spaceId,
      nickname: nickname,
...
class CreateCreditCardCard {
  ...
  CreateCreditCardCard({required this.id});
}
...
class CreateCreditCardAudit {
  ...
  CreateCreditCardAudit({required this.id});
}
...
class CreateCreditCardData {
  ...
  bool operator ==(Object other) {
    ...
    return card == otherTyped.card && audit == otherTyped.audit;
  }
  ...
  CreateCreditCardData({required this.card, required this.audit});
}
...
class CreateCreditCardVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateCreditCardVariables otherTyped =
        other as CreateCreditCardVariables;
