...
class CreateCashFlowRecurrenceSeriesVariablesBuilder {
  ...
  Optional<int> _occurrenceLimit = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  CreateCashFlowRecurrenceSeriesVariablesBuilder nextOccurrenceDate(
    DateTime? t,
  ) {
  ...
  Deserializer<CreateCashFlowRecurrenceSeriesData> dataDeserializer =
      (dynamic json) =>
          CreateCashFlowRecurrenceSeriesData.fromJson(jsonDecode(json));
  Serializer<CreateCashFlowRecurrenceSeriesVariables> varsSerializer =
      (CreateCashFlowRecurrenceSeriesVariables vars) =>
...
class CreateCashFlowRecurrenceSeriesSeries {
  ...
  bool operator ==(Object other) {
    ...
    final CreateCashFlowRecurrenceSeriesSeries otherTyped =
        other as CreateCashFlowRecurrenceSeriesSeries;
  ...
  CreateCashFlowRecurrenceSeriesSeries({required this.id});
}
...
class CreateCashFlowRecurrenceSeriesAudit {
  ...
  bool operator ==(Object other) {
    ...
    final CreateCashFlowRecurrenceSeriesAudit otherTyped =
        other as CreateCashFlowRecurrenceSeriesAudit;
    return id == otherTyped.id;
  }
  ...
  CreateCashFlowRecurrenceSeriesAudit({required this.id});
}
...
class CreateCashFlowRecurrenceSeriesData {
  ...
  bool operator ==(Object other) {
    ...
    final CreateCashFlowRecurrenceSeriesData otherTyped =
        other as CreateCashFlowRecurrenceSeriesData;
    return series == otherTyped.series && audit == otherTyped.audit;
  }
...
class CreateCashFlowRecurrenceSeriesVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateCashFlowRecurrenceSeriesVariables otherTyped =
        other as CreateCashFlowRecurrenceSeriesVariables;
