...
class UpdateCashFlowSeriesFromVariablesBuilder {
  ...
  UpdateCashFlowSeriesFromVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.seriesId,required  this.scope,required  this.cutoffAt,required  this.description,required  this.kind,required  this.paymentMethod,required  this.amountCents,required  this.entryStatus,});
  Deserializer<UpdateCashFlowSeriesFromData> dataDeserializer = (dynamic json)  => UpdateCashFlowSeriesFromData.fromJson(jsonDecode(json));
  Serializer<UpdateCashFlowSeriesFromVariables> varsSerializer = (UpdateCashFlowSeriesFromVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateCashFlowSeriesFromData, UpdateCashFlowSeriesFromVariables>> execute() {
    return ref().execute();
  }
...
class UpdateCashFlowSeriesFromSeries {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateCashFlowSeriesFromSeries otherTyped = other as UpdateCashFlowSeriesFromSeries;
  ...
  UpdateCashFlowSeriesFromSeries({
    required this.id,
  });
}
...
class UpdateCashFlowSeriesFromData {
  ...
  series = json['series'] == null ? null : UpdateCashFlowSeriesFromSeries.fromJson(json['series']),
  ...
  bool operator ==(Object other) {
    ...
    final UpdateCashFlowSeriesFromData otherTyped = other as UpdateCashFlowSeriesFromData;
...
class UpdateCashFlowSeriesFromVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateCashFlowSeriesFromVariables otherTyped = other as UpdateCashFlowSeriesFromVariables;
