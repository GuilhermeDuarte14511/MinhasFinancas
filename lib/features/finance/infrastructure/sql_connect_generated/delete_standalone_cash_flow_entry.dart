...
class DeleteStandaloneCashFlowEntryVariablesBuilder {
  ...
  DeleteStandaloneCashFlowEntryVariablesBuilder(
    this._dataConnect, {
    required this.spaceId,
    required this.entryId,
    required this.scope,
  });
  Deserializer<DeleteStandaloneCashFlowEntryData> dataDeserializer =
      (dynamic json) =>
          DeleteStandaloneCashFlowEntryData.fromJson(jsonDecode(json));
  Serializer<DeleteStandaloneCashFlowEntryVariables> varsSerializer =
      (DeleteStandaloneCashFlowEntryVariables vars) =>
...
class DeleteStandaloneCashFlowEntryEntry {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteStandaloneCashFlowEntryEntry otherTyped =
        other as DeleteStandaloneCashFlowEntryEntry;
  ...
  DeleteStandaloneCashFlowEntryEntry({required this.id});
}
...
class DeleteStandaloneCashFlowEntryAudit {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteStandaloneCashFlowEntryAudit otherTyped =
        other as DeleteStandaloneCashFlowEntryAudit;
    return id == otherTyped.id;
  }
  ...
  DeleteStandaloneCashFlowEntryAudit({required this.id});
}
...
class DeleteStandaloneCashFlowEntryData {
  ...
  DeleteStandaloneCashFlowEntryData.fromJson(dynamic json)
    : entry = json['entry'] == null
          ? null
          : DeleteStandaloneCashFlowEntryEntry.fromJson(json['entry']),
  ...
  bool operator ==(Object other) {
    ...
    final DeleteStandaloneCashFlowEntryData otherTyped =
        other as DeleteStandaloneCashFlowEntryData;
  ...
  DeleteStandaloneCashFlowEntryData({this.entry, required this.audit});
}
...
class DeleteStandaloneCashFlowEntryVariables {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteStandaloneCashFlowEntryVariables otherTyped =
        other as DeleteStandaloneCashFlowEntryVariables;
  ...
  @override
  int get hashCode =>
      Object.hashAll([spaceId.hashCode, entryId.hashCode, scope.hashCode]);
