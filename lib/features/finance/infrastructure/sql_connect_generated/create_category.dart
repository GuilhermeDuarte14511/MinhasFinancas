...
class CreateCategoryVariablesBuilder {
  ...
  CreateCategoryVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.name,required  this.normalizedName,required  this.icon,required  this.colorHex,});
  ...
  MutationRef<CreateCategoryData, CreateCategoryVariables> ref() {
    CreateCategoryVariables vars= CreateCategoryVariables(spaceId: spaceId,name: name,normalizedName: normalizedName,icon: icon,colorHex: colorHex,);
...
class CreateCategoryVariables {
  ...
  @override
  int get hashCode => Object.hashAll([spaceId.hashCode, name.hashCode, normalizedName.hashCode, icon.hashCode, colorHex.hashCode]);
