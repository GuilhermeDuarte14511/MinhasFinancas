...
class UpdateCategoryVariablesBuilder {
  ...
  UpdateCategoryVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.categoryId,required  this.name,required  this.normalizedName,});
  ...
  MutationRef<UpdateCategoryData, UpdateCategoryVariables> ref() {
    UpdateCategoryVariables vars= UpdateCategoryVariables(spaceId: spaceId,categoryId: categoryId,name: name,normalizedName: normalizedName,);
...
class UpdateCategoryData {
  ...
  category = json['category'] == null ? null : UpdateCategoryCategory.fromJson(json['category']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class UpdateCategoryVariables {
  ...
  @override
  int get hashCode => Object.hashAll([spaceId.hashCode, categoryId.hashCode, name.hashCode, normalizedName.hashCode]);
