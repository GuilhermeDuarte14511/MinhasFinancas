...
class RegisterInvoicePaymentVariablesBuilder {
  ...
  RegisterInvoicePaymentVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<RegisterInvoicePaymentData> dataDeserializer = (dynamic json) =>
      RegisterInvoicePaymentData.fromJson(jsonDecode(json));
  Serializer<RegisterInvoicePaymentVariables> varsSerializer =
      (RegisterInvoicePaymentVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<RegisterInvoicePaymentData, RegisterInvoicePaymentVariables>
  >
  execute() {
    return ref().execute();
  }

  MutationRef<RegisterInvoicePaymentData, RegisterInvoicePaymentVariables>
  ref() {
    RegisterInvoicePaymentVariables vars = RegisterInvoicePaymentVariables(
      spaceId: spaceId,
      invoiceId: invoiceId,
...
class RegisterInvoicePaymentPayment {
  ...
  bool operator ==(Object other) {
    ...
    final RegisterInvoicePaymentPayment otherTyped =
        other as RegisterInvoicePaymentPayment;
  ...
  RegisterInvoicePaymentPayment({required this.id});
}
...
class RegisterInvoicePaymentInvoice {
  ...
  bool operator ==(Object other) {
    ...
    final RegisterInvoicePaymentInvoice otherTyped =
        other as RegisterInvoicePaymentInvoice;
    return id == otherTyped.id;
  }
  ...
  RegisterInvoicePaymentInvoice({required this.id});
}
...
class RegisterInvoicePaymentAudit {
  ...
  bool operator ==(Object other) {
    ...
    final RegisterInvoicePaymentAudit otherTyped =
        other as RegisterInvoicePaymentAudit;
    return id == otherTyped.id;
  }
  ...
  RegisterInvoicePaymentAudit({required this.id});
}
...
class RegisterInvoicePaymentData {
  ...
  RegisterInvoicePaymentData.fromJson(dynamic json)
    : payment = RegisterInvoicePaymentPayment.fromJson(json['payment']),
      invoice = json['invoice'] == null
          ? null
          : RegisterInvoicePaymentInvoice.fromJson(json['invoice']),
  ...
  bool operator ==(Object other) {
    ...
    final RegisterInvoicePaymentData otherTyped =
        other as RegisterInvoicePaymentData;
  ...
  @override
  int get hashCode =>
      Object.hashAll([payment.hashCode, invoice.hashCode, audit.hashCode]);
...
class RegisterInvoicePaymentVariables {
  ...
  bool operator ==(Object other) {
    ...
    final RegisterInvoicePaymentVariables otherTyped =
        other as RegisterInvoicePaymentVariables;
  ...
  Map<String, dynamic> toJson() {
    ...
    json['resultingStatus'] = resultingStatus.name;
    return json;
  }
