...
class CancelPurchaseInstallmentVariablesBuilder {
  ...
  CancelPurchaseInstallmentVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CancelPurchaseInstallmentData> dataDeserializer =
      (dynamic json) =>
          CancelPurchaseInstallmentData.fromJson(jsonDecode(json));
  Serializer<CancelPurchaseInstallmentVariables> varsSerializer =
      (CancelPurchaseInstallmentVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<
  ...
  MutationRef<CancelPurchaseInstallmentData, CancelPurchaseInstallmentVariables>
  ref() {
    CancelPurchaseInstallmentVariables vars =
        CancelPurchaseInstallmentVariables(
          spaceId: spaceId,
...
class CancelPurchaseInstallmentInstallment {
  ...
  bool operator ==(Object other) {
    ...
    final CancelPurchaseInstallmentInstallment otherTyped =
        other as CancelPurchaseInstallmentInstallment;
  ...
  CancelPurchaseInstallmentInstallment({required this.id});
}
...
class CancelPurchaseInstallmentInvoice {
  ...
  bool operator ==(Object other) {
    ...
    final CancelPurchaseInstallmentInvoice otherTyped =
        other as CancelPurchaseInstallmentInvoice;
    return id == otherTyped.id;
  }
  ...
  CancelPurchaseInstallmentInvoice({required this.id});
}
...
class CancelPurchaseInstallmentData {
  ...
  CancelPurchaseInstallmentData.fromJson(dynamic json)
    : installment = json['installment'] == null
          ? null
          : CancelPurchaseInstallmentInstallment.fromJson(json['installment']),
      invoice = json['invoice'] == null
          ? null
          : CancelPurchaseInstallmentInvoice.fromJson(json['invoice']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
    ...
    final CancelPurchaseInstallmentData otherTyped =
        other as CancelPurchaseInstallmentData;
  ...
  CancelPurchaseInstallmentData({this.installment, this.invoice});
}
...
class CancelPurchaseInstallmentVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CancelPurchaseInstallmentVariables otherTyped =
        other as CancelPurchaseInstallmentVariables;
