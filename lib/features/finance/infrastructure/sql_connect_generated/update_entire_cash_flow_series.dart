...
class UpdateEntireCashFlowSeriesVariablesBuilder {
  ...
  UpdateEntireCashFlowSeriesVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.seriesId,required  this.scope,required  this.description,required  this.kind,required  this.paymentMethod,required  this.amountCents,required  this.entryStatus,});
  Deserializer<UpdateEntireCashFlowSeriesData> dataDeserializer = (dynamic json)  => UpdateEntireCashFlowSeriesData.fromJson(jsonDecode(json));
  Serializer<UpdateEntireCashFlowSeriesVariables> varsSerializer = (UpdateEntireCashFlowSeriesVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateEntireCashFlowSeriesData, UpdateEntireCashFlowSeriesVariables>> execute() {
    return ref().execute();
  }
...
class UpdateEntireCashFlowSeriesSeries {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateEntireCashFlowSeriesSeries otherTyped = other as UpdateEntireCashFlowSeriesSeries;
  ...
  UpdateEntireCashFlowSeriesSeries({
    required this.id,
  });
}
...
class UpdateEntireCashFlowSeriesData {
  ...
  series = json['series'] == null ? null : UpdateEntireCashFlowSeriesSeries.fromJson(json['series']),
  ...
  bool operator ==(Object other) {
    ...
    final UpdateEntireCashFlowSeriesData otherTyped = other as UpdateEntireCashFlowSeriesData;
    return series == otherTyped.series && 
    entries == otherTyped.entries;
...
class UpdateEntireCashFlowSeriesVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateEntireCashFlowSeriesVariables otherTyped = other as UpdateEntireCashFlowSeriesVariables;
