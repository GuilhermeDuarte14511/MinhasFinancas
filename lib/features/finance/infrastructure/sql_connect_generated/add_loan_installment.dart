...
class AddLoanInstallmentVariablesBuilder {
  ...
  AddLoanInstallmentVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.loanId,required  this.installmentNumber,required  this.dueDate,required  this.openingBalanceCents,required  this.principalAmountCents,required  this.interestAmountCents,required  this.totalAmountCents,});
  Deserializer<AddLoanInstallmentData> dataDeserializer = (dynamic json)  => AddLoanInstallmentData.fromJson(jsonDecode(json));
  Serializer<AddLoanInstallmentVariables> varsSerializer = (AddLoanInstallmentVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<AddLoanInstallmentData, AddLoanInstallmentVariables>> execute() {
    return ref().execute();
  }

  MutationRef<AddLoanInstallmentData, AddLoanInstallmentVariables> ref() {
    AddLoanInstallmentVariables vars= AddLoanInstallmentVariables(spaceId: spaceId,loanId: loanId,installmentNumber: installmentNumber,dueDate: dueDate,openingBalanceCents: openingBalanceCents,principalAmountCents: principalAmountCents,interestAmountCents: interestAmountCents,totalAmountCents: totalAmountCents,);
    return _dataConnect.mutation("AddLoanInstallment", dataDeserializer, varsSerializer, vars);
  }
}
...
class AddLoanInstallmentInstallment {
  ...
  bool operator ==(Object other) {
    ...
    final AddLoanInstallmentInstallment otherTyped = other as AddLoanInstallmentInstallment;
...
class AddLoanInstallmentVariables {
  ...
  bool operator ==(Object other) {
    ...
    final AddLoanInstallmentVariables otherTyped = other as AddLoanInstallmentVariables;
  ...
  @override
  int get hashCode => Object.hashAll([spaceId.hashCode, loanId.hashCode, installmentNumber.hashCode, dueDate.hashCode, openingBalanceCents.hashCode, principalAmountCents.hashCode, interestAmountCents.hashCode, totalAmountCents.hashCode]);
