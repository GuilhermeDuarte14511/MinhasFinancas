...
class CancelCashFlowEntryVariablesBuilder {
  ...
  CancelCashFlowEntryVariablesBuilder(
    this._dataConnect, {
    required this.spaceId,
    required this.entryId,
    required this.reason,
  });
  Deserializer<CancelCashFlowEntryData> dataDeserializer = (dynamic json) =>
      CancelCashFlowEntryData.fromJson(jsonDecode(json));
  Serializer<CancelCashFlowEntryVariables> varsSerializer =
      (CancelCashFlowEntryVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CancelCashFlowEntryData, CancelCashFlowEntryVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CancelCashFlowEntryData, CancelCashFlowEntryVariables> ref() {
    CancelCashFlowEntryVariables vars = CancelCashFlowEntryVariables(
      spaceId: spaceId,
      entryId: entryId,
      reason: reason,
    );
...
class CancelCashFlowEntryEntry {
  ...
  bool operator ==(Object other) {
    ...
    final CancelCashFlowEntryEntry otherTyped =
        other as CancelCashFlowEntryEntry;
  ...
  CancelCashFlowEntryEntry({required this.id});
}
...
class CancelCashFlowEntryAudit {
  ...
  bool operator ==(Object other) {
    ...
    final CancelCashFlowEntryAudit otherTyped =
        other as CancelCashFlowEntryAudit;
    return id == otherTyped.id;
  }
  ...
  CancelCashFlowEntryAudit({required this.id});
}
...
class CancelCashFlowEntryData {
  ...
  CancelCashFlowEntryData.fromJson(dynamic json)
    : entry = json['entry'] == null
          ? null
          : CancelCashFlowEntryEntry.fromJson(json['entry']),
  ...
  CancelCashFlowEntryData({this.entry, required this.audit});
}
...
class CancelCashFlowEntryVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CancelCashFlowEntryVariables otherTyped =
        other as CancelCashFlowEntryVariables;
  ...
  @override
  int get hashCode =>
      Object.hashAll([spaceId.hashCode, entryId.hashCode, reason.hashCode]);
