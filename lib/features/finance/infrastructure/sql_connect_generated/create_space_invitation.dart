...
class CreateSpaceInvitationVariablesBuilder {
  ...
  CreateSpaceInvitationVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateSpaceInvitationData> dataDeserializer = (dynamic json) =>
      CreateSpaceInvitationData.fromJson(jsonDecode(json));
  Serializer<CreateSpaceInvitationVariables> varsSerializer =
      (CreateSpaceInvitationVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<CreateSpaceInvitationData, CreateSpaceInvitationVariables>
  >
  execute() {
    return ref().execute();
  }
  ...
  MutationRef<CreateSpaceInvitationData, CreateSpaceInvitationVariables> ref() {
    CreateSpaceInvitationVariables vars = CreateSpaceInvitationVariables(
      spaceId: spaceId,
      email: email,
...
class CreateSpaceInvitationInvitation {
  ...
  bool operator ==(Object other) {
    ...
    final CreateSpaceInvitationInvitation otherTyped =
        other as CreateSpaceInvitationInvitation;
  ...
  CreateSpaceInvitationInvitation({required this.id});
}
...
class CreateSpaceInvitationAudit {
  ...
  bool operator ==(Object other) {
    ...
    final CreateSpaceInvitationAudit otherTyped =
        other as CreateSpaceInvitationAudit;
    return id == otherTyped.id;
  }
  ...
  CreateSpaceInvitationAudit({required this.id});
}
...
class CreateSpaceInvitationData {
  ...
  bool operator ==(Object other) {
    ...
    final CreateSpaceInvitationData otherTyped =
        other as CreateSpaceInvitationData;
    return invitation == otherTyped.invitation && audit == otherTyped.audit;
  }
  ...
  CreateSpaceInvitationData({required this.invitation, required this.audit});
}
...
class CreateSpaceInvitationVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateSpaceInvitationVariables otherTyped =
        other as CreateSpaceInvitationVariables;
