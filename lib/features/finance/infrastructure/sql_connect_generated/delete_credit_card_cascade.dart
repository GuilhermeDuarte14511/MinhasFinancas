...
class DeleteCreditCardCascadeVariablesBuilder {
  ...
  DeleteCreditCardCascadeVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.cardId,});
  Deserializer<DeleteCreditCardCascadeData> dataDeserializer = (dynamic json)  => DeleteCreditCardCascadeData.fromJson(jsonDecode(json));
  Serializer<DeleteCreditCardCascadeVariables> varsSerializer = (DeleteCreditCardCascadeVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteCreditCardCascadeData, DeleteCreditCardCascadeVariables>> execute() {
    return ref().execute();
  }

  MutationRef<DeleteCreditCardCascadeData, DeleteCreditCardCascadeVariables> ref() {
    DeleteCreditCardCascadeVariables vars= DeleteCreditCardCascadeVariables(spaceId: spaceId,cardId: cardId,);
    return _dataConnect.mutation("DeleteCreditCardCascade", dataDeserializer, varsSerializer, vars);
  }
}
...
class DeleteCreditCardCascadeCard {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteCreditCardCascadeCard otherTyped = other as DeleteCreditCardCascadeCard;
...
class DeleteCreditCardCascadeAudit {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteCreditCardCascadeAudit otherTyped = other as DeleteCreditCardCascadeAudit;
    return id == otherTyped.id;
...
class DeleteCreditCardCascadeData {
  ...
  card = json['card'] == null ? null : DeleteCreditCardCascadeCard.fromJson(json['card']),
  ...
  bool operator ==(Object other) {
    ...
    final DeleteCreditCardCascadeData otherTyped = other as DeleteCreditCardCascadeData;
  ...
  @override
  int get hashCode => Object.hashAll([directNotifications.hashCode, invoicePayments.hashCode, installments.hashCode, generatedCashFlow.hashCode, invoices.hashCode, purchases.hashCode, card.hashCode, audit.hashCode]);
...
class DeleteCreditCardCascadeVariables {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteCreditCardCascadeVariables otherTyped = other as DeleteCreditCardCascadeVariables;
