...
class FindCreditCardInvoiceVariablesBuilder {
  ...
  FindCreditCardInvoiceVariablesBuilder(this._dataConnect, {required  this.spaceId,required  this.cardId,required  this.referenceMonth,});
  Deserializer<FindCreditCardInvoiceData> dataDeserializer = (dynamic json)  => FindCreditCardInvoiceData.fromJson(jsonDecode(json));
  Serializer<FindCreditCardInvoiceVariables> varsSerializer = (FindCreditCardInvoiceVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<FindCreditCardInvoiceData, FindCreditCardInvoiceVariables>> execute({QueryFetchPolicy fetchPolicy = QueryFetchPolicy.preferCache}) {
    return ref().execute(fetchPolicy: fetchPolicy);
  }

  QueryRef<FindCreditCardInvoiceData, FindCreditCardInvoiceVariables> ref() {
    FindCreditCardInvoiceVariables vars= FindCreditCardInvoiceVariables(spaceId: spaceId,cardId: cardId,referenceMonth: referenceMonth,);
    return _dataConnect.query("FindCreditCardInvoice", dataDeserializer, varsSerializer, vars);
  }
}
...
class FindCreditCardInvoiceCreditCardInvoices {
  ...
  bool operator ==(Object other) {
    ...
    final FindCreditCardInvoiceCreditCardInvoices otherTyped = other as FindCreditCardInvoiceCreditCardInvoices;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, totalAmountCents.hashCode, paidAmountCents.hashCode, status.hashCode]);
...
class FindCreditCardInvoiceData {
  ...
  bool operator ==(Object other) {
    ...
    final FindCreditCardInvoiceData otherTyped = other as FindCreditCardInvoiceData;
...
class FindCreditCardInvoiceVariables {
  ...
  bool operator ==(Object other) {
    ...
    final FindCreditCardInvoiceVariables otherTyped = other as FindCreditCardInvoiceVariables;
  ...
  @override
  int get hashCode => Object.hashAll([spaceId.hashCode, cardId.hashCode, referenceMonth.hashCode]);
