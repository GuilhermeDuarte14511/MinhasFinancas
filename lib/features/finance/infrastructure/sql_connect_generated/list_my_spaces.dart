...
class ListMySpacesVariablesBuilder {
  ...
  Deserializer<ListMySpacesData> dataDeserializer = (dynamic json)  => ListMySpacesData.fromJson(jsonDecode(json));
  
  Future<QueryResult<ListMySpacesData, void>> execute({QueryFetchPolicy fetchPolicy = QueryFetchPolicy.preferCache}) {
    return ref().execute(fetchPolicy: fetchPolicy);
  }

  QueryRef<ListMySpacesData, void> ref() {
    
    return _dataConnect.query("ListMySpaces", dataDeserializer, emptySerializer, null);
  }
}
...
class ListMySpacesSpaceMembers {
  ...
  financialSpace = ListMySpacesSpaceMembersFinancialSpace.fromJson(json['financialSpace']);
  @override
  bool operator ==(Object other) {
    ...
    final ListMySpacesSpaceMembers otherTyped = other as ListMySpacesSpaceMembers;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, role.hashCode, joinedAt.hashCode, financialSpace.hashCode]);
...
class ListMySpacesSpaceMembersFinancialSpace {
  ...
  bool operator ==(Object other) {
    ...
    final ListMySpacesSpaceMembersFinancialSpace otherTyped = other as ListMySpacesSpaceMembersFinancialSpace;
    return id == otherTyped.id && 
