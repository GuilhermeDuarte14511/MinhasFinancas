...
class GetAgendaEntriesVariablesBuilder {
  ...
  GetAgendaEntriesVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<GetAgendaEntriesData> dataDeserializer = (dynamic json) =>
      GetAgendaEntriesData.fromJson(jsonDecode(json));
  Serializer<GetAgendaEntriesVariables> varsSerializer =
      (GetAgendaEntriesVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetAgendaEntriesData, GetAgendaEntriesVariables>> execute({
  ...
  QueryRef<GetAgendaEntriesData, GetAgendaEntriesVariables> ref() {
    GetAgendaEntriesVariables vars = GetAgendaEntriesVariables(
      spaceId: spaceId,
...
class GetAgendaEntriesCashFlowEntries {
  ...
  GetAgendaEntriesCashFlowEntries.fromJson(dynamic json)
    : id = nativeFromJson<String>(json['id']),
      ...
      category = json['category'] == null
          ? null
          : GetAgendaEntriesCashFlowEntriesCategory.fromJson(json['category']),
      recurrenceSeries = json['recurrenceSeries'] == null
          ? null
          : GetAgendaEntriesCashFlowEntriesRecurrenceSeries.fromJson(
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesCashFlowEntries otherTyped =
        other as GetAgendaEntriesCashFlowEntries;
...
class GetAgendaEntriesCashFlowEntriesCategory {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesCashFlowEntriesCategory otherTyped =
        other as GetAgendaEntriesCashFlowEntriesCategory;
    return id == otherTyped.id &&
...
class GetAgendaEntriesCashFlowEntriesRecurrenceSeries {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesCashFlowEntriesRecurrenceSeries otherTyped =
        other as GetAgendaEntriesCashFlowEntriesRecurrenceSeries;
    return id == otherTyped.id &&
...
class GetAgendaEntriesCreditCardInvoices {
  ...
  GetAgendaEntriesCreditCardInvoices.fromJson(dynamic json)
    : id = nativeFromJson<String>(json['id']),
      ...
      creditCard = GetAgendaEntriesCreditCardInvoicesCreditCard.fromJson(
        json['creditCard'],
      );
  @override
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesCreditCardInvoices otherTyped =
        other as GetAgendaEntriesCreditCardInvoices;
    return id == otherTyped.id &&
...
class GetAgendaEntriesCreditCardInvoicesCreditCard {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesCreditCardInvoicesCreditCard otherTyped =
        other as GetAgendaEntriesCreditCardInvoicesCreditCard;
    return id == otherTyped.id &&
...
class GetAgendaEntriesPurchaseInstallments {
  ...
  GetAgendaEntriesPurchaseInstallments.fromJson(dynamic json)
    : id = nativeFromJson<String>(json['id']),
      ...
      purchase = GetAgendaEntriesPurchaseInstallmentsPurchase.fromJson(
        json['purchase'],
      ),
      invoice = GetAgendaEntriesPurchaseInstallmentsInvoice.fromJson(
        json['invoice'],
      );
  @override
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesPurchaseInstallments otherTyped =
        other as GetAgendaEntriesPurchaseInstallments;
    return id == otherTyped.id &&
...
class GetAgendaEntriesPurchaseInstallmentsPurchase {
  ...
  GetAgendaEntriesPurchaseInstallmentsPurchase.fromJson(dynamic json)
    : id = nativeFromJson<String>(json['id']),
      description = nativeFromJson<String>(json['description']),
      creditCard =
          GetAgendaEntriesPurchaseInstallmentsPurchaseCreditCard.fromJson(
            json['creditCard'],
          );
  @override
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesPurchaseInstallmentsPurchase otherTyped =
        other as GetAgendaEntriesPurchaseInstallmentsPurchase;
    return id == otherTyped.id &&
        description == otherTyped.description &&
        creditCard == otherTyped.creditCard;
  }
  ...
  @override
  int get hashCode =>
      Object.hashAll([id.hashCode, description.hashCode, creditCard.hashCode]);
...
class GetAgendaEntriesPurchaseInstallmentsPurchaseCreditCard {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesPurchaseInstallmentsPurchaseCreditCard otherTyped =
        other as GetAgendaEntriesPurchaseInstallmentsPurchaseCreditCard;
    return id == otherTyped.id &&
        nickname == otherTyped.nickname &&
        lastFourDigits == otherTyped.lastFourDigits &&
        colorHex == otherTyped.colorHex;
...
class GetAgendaEntriesPurchaseInstallmentsInvoice {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesPurchaseInstallmentsInvoice otherTyped =
        other as GetAgendaEntriesPurchaseInstallmentsInvoice;
    return id == otherTyped.id &&
        referenceMonth == otherTyped.referenceMonth &&
        status == otherTyped.status;
  }
  ...
  @override
  int get hashCode =>
      Object.hashAll([id.hashCode, referenceMonth.hashCode, status.hashCode]);
...
class GetAgendaEntriesLoanInstallments {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesLoanInstallments otherTyped =
        other as GetAgendaEntriesLoanInstallments;
    return id == otherTyped.id &&
        installmentNumber == otherTyped.installmentNumber &&
        dueDate == otherTyped.dueDate &&
        totalAmountCents == otherTyped.totalAmountCents &&
...
class GetAgendaEntriesLoanInstallmentsLoan {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesLoanInstallmentsLoan otherTyped =
        other as GetAgendaEntriesLoanInstallmentsLoan;
    return id == otherTyped.id &&
        name == otherTyped.name &&
...
class GetAgendaEntriesRecurrenceSeries {
  ...
  GetAgendaEntriesRecurrenceSeries.fromJson(dynamic json)
    : id = nativeFromJson<String>(json['id']),
      ...
      category = json['category'] == null
          ? null
          : GetAgendaEntriesRecurrenceSeriesCategory.fromJson(json['category']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
    ...
    final GetAgendaEntriesRecurrenceSeries otherTyped =
        other as GetAgendaEntriesRecurrenceSeries;
    return id == otherTyped.id &&
        direction == otherTyped.direction &&
        kind == otherTyped.kind &&
        paymentMethod == otherTyped.paymentMethod &&
...
class GetAgendaEntriesRecurrenceSeriesCategory {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesRecurrenceSeriesCategory otherTyped =
        other as GetAgendaEntriesRecurrenceSeriesCategory;
    return id == otherTyped.id &&
        name == otherTyped.name &&
        icon == otherTyped.icon &&
        colorHex == otherTyped.colorHex;
...
class GetAgendaEntriesVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetAgendaEntriesVariables otherTyped =
        other as GetAgendaEntriesVariables;
  ...
  int get hashCode => Object.hashAll([
    ...
    rangeStart.hashCode,
    rangeEnd.hashCode,
    rangeStartDate.hashCode,
    rangeEndDate.hashCode,
  ]);
