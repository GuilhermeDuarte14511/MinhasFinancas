...
class CancelLoanVariablesBuilder {
  ...
  CancelLoanVariablesBuilder(
    this._dataConnect, {
    required this.spaceId,
    required this.loanId,
  });
  Deserializer<CancelLoanData> dataDeserializer = (dynamic json) =>
      CancelLoanData.fromJson(jsonDecode(json));
  Serializer<CancelLoanVariables> varsSerializer = (CancelLoanVariables vars) =>
  ...
  MutationRef<CancelLoanData, CancelLoanVariables> ref() {
    CancelLoanVariables vars = CancelLoanVariables(
      spaceId: spaceId,
      loanId: loanId,
    );
...
class CancelLoanLoan {
  ...
  CancelLoanLoan({required this.id});
}
...
class CancelLoanData {
  ...
  CancelLoanData.fromJson(dynamic json)
    : loan = json['loan'] == null
          ? null
          : CancelLoanLoan.fromJson(json['loan']),
  ...
  bool operator ==(Object other) {
    ...
    return loan == otherTyped.loan && installments == otherTyped.installments;
  }
  ...
  CancelLoanData({this.loan, required this.installments});
}
...
class CancelLoanVariables {
  ...
  bool operator ==(Object other) {
    ...
    return spaceId == otherTyped.spaceId && loanId == otherTyped.loanId;
  }
  ...
  CancelLoanVariables({required this.spaceId, required this.loanId});
}
