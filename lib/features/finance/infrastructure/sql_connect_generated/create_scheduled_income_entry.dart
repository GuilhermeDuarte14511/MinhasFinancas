...
class CreateScheduledIncomeEntryVariablesBuilder {
  ...
  CreateScheduledIncomeEntryVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateScheduledIncomeEntryData> dataDeserializer =
      (dynamic json) =>
          CreateScheduledIncomeEntryData.fromJson(jsonDecode(json));
  Serializer<CreateScheduledIncomeEntryVariables> varsSerializer =
      (CreateScheduledIncomeEntryVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<
  ...
  >
  ref() {
    CreateScheduledIncomeEntryVariables vars =
        CreateScheduledIncomeEntryVariables(
          spaceId: spaceId,
...
class CreateScheduledIncomeEntryEntry {
  ...
  bool operator ==(Object other) {
    ...
    final CreateScheduledIncomeEntryEntry otherTyped =
        other as CreateScheduledIncomeEntryEntry;
  ...
  CreateScheduledIncomeEntryEntry({required this.id});
}
...
class CreateScheduledIncomeEntryAudit {
  ...
  bool operator ==(Object other) {
    ...
    final CreateScheduledIncomeEntryAudit otherTyped =
        other as CreateScheduledIncomeEntryAudit;
    return id == otherTyped.id;
  }
  ...
  CreateScheduledIncomeEntryAudit({required this.id});
}
...
class CreateScheduledIncomeEntryData {
  ...
  bool operator ==(Object other) {
    ...
    final CreateScheduledIncomeEntryData otherTyped =
        other as CreateScheduledIncomeEntryData;
  ...
  CreateScheduledIncomeEntryData({required this.entry, required this.audit});
}
...
class CreateScheduledIncomeEntryVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateScheduledIncomeEntryVariables otherTyped =
        other as CreateScheduledIncomeEntryVariables;
