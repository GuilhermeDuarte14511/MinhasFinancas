...
class CreatePurchaseVariablesBuilder {
  ...
  String categoryId;
  String description;
  Optional<String> _merchantName = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  CreatePurchaseVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreatePurchaseData> dataDeserializer = (dynamic json) =>
      CreatePurchaseData.fromJson(jsonDecode(json));
  Serializer<CreatePurchaseVariables> varsSerializer =
      (CreatePurchaseVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreatePurchaseData, CreatePurchaseVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreatePurchaseData, CreatePurchaseVariables> ref() {
    CreatePurchaseVariables vars = CreatePurchaseVariables(
      spaceId: spaceId,
      cardId: cardId,
...
class CreatePurchasePurchase {
  ...
  CreatePurchasePurchase({required this.id});
}
...
class CreatePurchaseAudit {
  ...
  CreatePurchaseAudit({required this.id});
}
...
class CreatePurchaseData {
  ...
  bool operator ==(Object other) {
    ...
    return purchase == otherTyped.purchase && audit == otherTyped.audit;
  }
  ...
  CreatePurchaseData({required this.purchase, required this.audit});
}
...
class CreatePurchaseVariables {
  ...
  CreatePurchaseVariables.fromJson(Map<String, dynamic> json)
    ...
    merchantName.value = json['merchantName'] == null
        ? null
