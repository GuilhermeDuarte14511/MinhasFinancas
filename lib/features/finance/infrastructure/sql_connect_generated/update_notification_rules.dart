...
class UpdateNotificationRulesVariablesBuilder {
  ...
  UpdateNotificationRulesVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<UpdateNotificationRulesData> dataDeserializer = (dynamic json) =>
      UpdateNotificationRulesData.fromJson(jsonDecode(json));
  Serializer<UpdateNotificationRulesVariables> varsSerializer =
      (UpdateNotificationRulesVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<
  ...
  MutationRef<UpdateNotificationRulesData, UpdateNotificationRulesVariables>
  ref() {
    UpdateNotificationRulesVariables vars = UpdateNotificationRulesVariables(
      spaceId: spaceId,
...
class UpdateNotificationRulesClosing {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationRulesClosing otherTyped =
        other as UpdateNotificationRulesClosing;
  ...
  UpdateNotificationRulesClosing({required this.id});
}
...
class UpdateNotificationRulesDue {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationRulesDue otherTyped =
        other as UpdateNotificationRulesDue;
    return id == otherTyped.id;
  }
  ...
  UpdateNotificationRulesDue({required this.id});
}
...
class UpdateNotificationRulesLoan {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationRulesLoan otherTyped =
        other as UpdateNotificationRulesLoan;
    return id == otherTyped.id;
  }
  ...
  UpdateNotificationRulesLoan({required this.id});
}
...
class UpdateNotificationRulesData {
  ...
  UpdateNotificationRulesData.fromJson(dynamic json)
    : closing = json['closing'] == null
          ? null
          : UpdateNotificationRulesClosing.fromJson(json['closing']),
      due = json['due'] == null
          ? null
          : UpdateNotificationRulesDue.fromJson(json['due']),
      loan = json['loan'] == null
          ? null
          : UpdateNotificationRulesLoan.fromJson(json['loan']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
    ...
    final UpdateNotificationRulesData otherTyped =
        other as UpdateNotificationRulesData;
  ...
  @override
  int get hashCode =>
      Object.hashAll([closing.hashCode, due.hashCode, loan.hashCode]);
  ...
  UpdateNotificationRulesData({this.closing, this.due, this.loan});
}
...
class UpdateNotificationRulesVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationRulesVariables otherTyped =
        other as UpdateNotificationRulesVariables;
