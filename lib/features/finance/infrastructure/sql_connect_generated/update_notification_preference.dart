...
class UpdateNotificationPreferenceVariablesBuilder {
  ...
  UpdateNotificationPreferenceVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<UpdateNotificationPreferenceData> dataDeserializer =
      (dynamic json) =>
          UpdateNotificationPreferenceData.fromJson(jsonDecode(json));
  Serializer<UpdateNotificationPreferenceVariables> varsSerializer =
      (UpdateNotificationPreferenceVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<
  ...
  >
  ref() {
    UpdateNotificationPreferenceVariables vars =
        UpdateNotificationPreferenceVariables(
          spaceId: spaceId,
          enabled: enabled,
...
class UpdateNotificationPreferencePreference {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationPreferencePreference otherTyped =
        other as UpdateNotificationPreferencePreference;
  ...
  UpdateNotificationPreferencePreference({required this.id});
}
...
class UpdateNotificationPreferenceData {
  ...
  UpdateNotificationPreferenceData.fromJson(dynamic json)
    : preference = json['preference'] == null
          ? null
          : UpdateNotificationPreferencePreference.fromJson(json['preference']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
    ...
    final UpdateNotificationPreferenceData otherTyped =
        other as UpdateNotificationPreferenceData;
  ...
  UpdateNotificationPreferenceData({this.preference});
}
...
class UpdateNotificationPreferenceVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationPreferenceVariables otherTyped =
        other as UpdateNotificationPreferenceVariables;
